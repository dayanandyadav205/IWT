...
<body>
    <header>
        <div>
            <img src="/images/iwt5.jpg" alt="IWT5 Logo" />
        </div>
        <div>
        ...
        <div>
            <img src="/images/nba.png" alt="" style="border-radius: 5px;">
        </div>
    </header>
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="/IWT_JavaScript_Code/3.3 conditions (if.. else if ... else).php">3.3 if...else...if</a>
                    </li>
                    ...
                    <li><a href="/IWT_JavaScript_Code/8.2 DOM manipulation.php">8.2 Dom manipulation (Attributes)</a>
                    </li>
                    <li><a href="/IWT_JavaScript_Code/8.3 DOM manipulation.php">8.3 Dom manipulation (Styles)</a></li>
                    <li><a href="/IWT_JavaScript_Code/8.4 DOM manipulation.php">8.4 Dom manipulation (Add Elements)</a>
                    </li>
                    <li><a href="/IWT_JavaScript_Code/8.5 DOM manipulation.php">8.5 Dom manipulation (Remove
                            Elements)</a></li>
                    <li><a href="/IWT_JavaScript_Code/8.6 DOM manipulation.php">8.6 Dom manipulation (Add
                            Attributes)</a></li>
                    <li><a href="/IWT_JavaScript_Code/8.7 DOM manipulation.php">8.7 Dom manipulation (Remove
                            Attributes)</a></li>
                    ...
                    <li><a href="/IWT_JavaScript_Code/11.3 onmouseup & onmousedown event.php">11.3 Event onmouseup &
                            onmousedown</a></li>
                </ul>
            </li>
